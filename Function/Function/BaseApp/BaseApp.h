...
public:
	...
	void setGameTimer(std::shared_ptr<function::GameTimer> pGameTimer);
	auto getGameTimer() const -> std::shared_ptr<function::GameTimer>;
protected:
	virtual void onInitialize(dx12lib::DirectContextProxy pDirectCtx) {}
	virtual void onDestroy() {}
	virtual void onBeginTick(std::shared_ptr<function::GameTimer> pGameTimer) {}
	virtual void onTick(std::shared_ptr<function::GameTimer> pGameTimer) {}
	virtual void onEndTick(std::shared_ptr<function::GameTimer> pGameTimer) {}
...
protected:
	...
	std::shared_ptr<function::GameTimer> _pGameTimer;
};
