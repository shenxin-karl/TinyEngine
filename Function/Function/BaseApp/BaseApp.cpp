...
#include "function/InputSystem/window.h"
...
void BaseApp::setGameTimer(std::shared_ptr<function::GameTimer> pGameTimer) {
	_pGameTimer = pGameTimer;
}

auto BaseApp::getGameTimer() const -> std::shared_ptr<function::GameTimer> {
	return _pGameTimer;
}
